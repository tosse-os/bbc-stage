...
@if($videoUrl)
<div class="video-mini-player media-entry-video rounded-2xl overflow-hidden bg-slate-800/40 border border-white/5 flex items-center px-4 py-2 gap-4">
  ...
  <div class="flex-1">
    <span class="media-entry-video-label text-[10px] font-bold text-slate-300 uppercase tracking-tighter">
      {{ dashboard_t('media.watch_video') }}
    </span>
    <div class="media-entry-video-track h-1 w-full bg-slate-700 rounded-full mt-1 overflow-hidden">
