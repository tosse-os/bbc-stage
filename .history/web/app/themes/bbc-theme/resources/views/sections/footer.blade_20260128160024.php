      ...
      <div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <div class="mt-4 flex gap-4">
            <a href="#" class="glow-item flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 text-slate-300 hover:border-brand-primary hover:text-white transition">
              @include('icons.x')
            </a>
