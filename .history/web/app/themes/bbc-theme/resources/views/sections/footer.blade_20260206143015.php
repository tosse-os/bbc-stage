<footer class="relative overflow-hidden bg-slate-950 text-slate-300">
  <div class="absolute inset-0">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-slate-950/20 via-slate-950/10 to-slate-950/30"></div>
  </div>
    ...
    <div class="container-content py-20">
      <div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        <div class="flex flex-col items-start gap-3 text-sm lg:items-end">
          <a href="#about" class="text-slate-200 hover:text-white transition">About</a>
          <a href="#about" class="hover:text-white transition">Services</a>
          <a href="#contact" class="hover:text-white transition">Contact</a>

          <div class="mt-6 flex gap-4 text-xs text-slate-500">
            <a href="/datenschutz" class="hover:text-slate-300 transition">Privacy policy</a>
            <span>·</span>
            <a href="/imprint" class="hover:text-slate-300 transition">Imprint</a>
          </div>
        </div>
