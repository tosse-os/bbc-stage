  ...
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden flex-1 justify-center gap-8 text-base text-slate-300 lg:flex">
        <a class="nav-link hover:text-brand-light" href="{{ home_url('/') }}#top">Home</a>
        <a class="nav-link hover:text-brand-light" href="{{ home_url('/') }}#about">About</a>
        <a class="nav-link hover:text-brand-light" href="{{ home_url('/') }}#contact">Contact & Support</a>
        <a class="nav-link hover:text-brand-light" href="{{ home_url('/') }}#team">Team</a>
        <a class="nav-link hover:text-brand-light" href="{{ home_url('/') }}#market-insights">Insights</a>
      </nav>
