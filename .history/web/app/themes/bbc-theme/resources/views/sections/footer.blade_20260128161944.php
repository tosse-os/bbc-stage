      ...
      <div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <div class="mt-4 flex gap-4">
            <a href="#" class="glow-icon flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 text-slate-300 hover:border-slate-700 hover:text-slate-100 transition">
              @include('icons.x')
            </a>
