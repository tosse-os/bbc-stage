<header
  id="siteHeader"
  class="fixed inset-x-0 top-0 z-50 backdrop-blur transition-[background-color] duration-300">
  ...
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden items-center gap-8 text-base text-slate-300 lg:flex">
        ...
        <div class="ml-8 flex rounded-md bg-white/5 p-0.5 text-xs font-medium uppercase tracking-wide text-white">
      ...
      <div class="flex items-center gap-3">
        ...
        {{-- <div class="flex rounded-md bg-white/5 p-0.5 text-[11px] font-medium uppercase tracking-wide text-white lg:hidden">
          @php($langs = pll_the_languages(['raw' => 1]))
          @foreach($langs as $lang)
          <a
            href="{{ $lang['url'] }}"
