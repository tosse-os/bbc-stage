  ...
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden flex-1 justify-center gap-8 text-base text-slate-300 lg:flex">
        <a class="nav-link transition hover:text-white" href="#top">Home</a>
        <a class="nav-link transition hover:text-white" href="#about">About</a>
        <a class="nav-link transition hover:text-white" href="#contact">Contact & Support</a>
        <a class="nav-link transition hover:text-white" href="#team">Team</a>
        <a class="nav-link transition hover:text-white" href="#market-insights">Insights</a>
      </nav>
