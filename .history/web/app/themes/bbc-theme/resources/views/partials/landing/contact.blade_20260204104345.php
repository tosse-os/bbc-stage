<section id="contact" class="relative overflow-hidden py-28 scroll-mt-20">
  ...
  <div class="relative container-content">
    <div
      ...
      {{-- RIGHT / TOP (FORM STARTET EXAKT HIER) --}}
      <div class="row-start-1 col-start-2 self-start">
        <div class="contact-card-soft rounded-[22px] bg-white/85 px-8 py-7 shadow-[0_18px_45px_rgba(15,70,85,0.22)]">
          <h3 class="mb-5 text-[17px] font-semibold text-brand-primaryFontDark">
            Get in touch
          </h3>
      ...
      {{-- LEFT / BOTTOM (BULLETS) --}}
      <div class="row-start-2 col-start-1 mt-2 space-y-9">
        <div class="flex items-center gap-5">
          <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-[0_8px_24px_rgba(15,70,85,0.12)] text-brand-primary">
