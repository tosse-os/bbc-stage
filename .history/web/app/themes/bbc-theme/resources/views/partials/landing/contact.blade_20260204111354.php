      ...
      <div>
        ...
        <div class="mt-14 space-y-9">
          <div class="group flex items-center gap-8">
            <div class="flex h-14 w-13 items-center justify-center rounded-xl bg-white/90 shadow-[0_10px_30px_rgba(15,70,85,0.16)] text-brand-primary transition-all duration-300 group-hover:scale-105 group-hover:bg-white group-hover:shadow-xl">
          ...
          <div class="group flex items-center gap-8">
            <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-white/90 shadow-[0_10px_30px_rgba(15,70,85,0.16)] text-brand-primary transition-all duration-300 group-hover:scale-105 group-hover:bg-white group-hover:shadow-xl">
              @include('icons.message')
            </div>
            <span class="text-xl font-medium text-brand-primaryFontDark">
