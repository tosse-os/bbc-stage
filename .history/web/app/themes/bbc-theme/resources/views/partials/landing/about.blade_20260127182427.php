      ...
      <div>
        ...
        <div class="mt-12 grid grid-cols-1 gap-x-16 gap-y-12 md:grid-cols-2">
          @for($i = 1; $i <= 4; $i++)
            ...
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-base font-medium text-brand-primary shadow-[0_1px_2px_rgba(0,0,0,0.06)]">
