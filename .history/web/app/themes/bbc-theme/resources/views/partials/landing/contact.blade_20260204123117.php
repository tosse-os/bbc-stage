        ...
        <div class="contact-card-soft rounded-[26px] bg-white/85 px-9 py-8 shadow-[0_22px_55px_rgba(15,70,85,0.28)]">
          ...
          <form class="space-y-4">
            <input
              ...
              class="w-full rounded-md border border-[#c9dbe2] bg-white px-4 py-2.5 text-[14px] text-[#3f5f6b] placeholder-[#8fa7b1]/70
         transition-all duration-300
         hover:border-[#5fa6bb]
         focus:border-[#3f879c] focus:ring-4 focus:ring-[#3f879c]/10 focus:outline-none">
