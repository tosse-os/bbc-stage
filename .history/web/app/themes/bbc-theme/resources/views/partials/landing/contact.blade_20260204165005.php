@php
error_log('BLADE DEBUG: contact.blade.php rendered');
@endphp
      ...
      <div class="mt-16">
        <div class="contact-card-soft rounded-[26px] bg-white/85 px-9 py-8 shadow-[0_22px_55px_rgba(15,70,85,0.28)]">
          ...
          <form id="contactForm" class="space-y-4" novalidate>
            ...
            <button
              type="submit"
              class="mt-4 w-full rounded-md bg-gradient-to-b from-[#4a97ad] to-[#3f879c] py-3 text-[14px] font-medium text-white shadow-[0_8px_22px_rgba(63,135,156,0.35)] transition-all duration-300 hover:from-[#3f879c] hover:to-[#35788b] hover:shadow-[0_12px_28px_rgba(63,135,156,0.45)] active:scale-[0.98] cursor-pointer">
              Send message
            </button>
          </form>
