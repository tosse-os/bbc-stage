<section id="contact" class="relative overflow-hidden py-16 lg:py-28 scroll-mt-15">
  ...
  <div class="relative container-content">
    <div class="grid grid-cols-1 lg:grid-cols-[1.6fr_1.1fr] gap-12 lg:gap-x-20 lg:gap-y-24 items-start">
      ...
      <div class="text-center lg:text-left">
        ...
        <p class="mt-5 mx-auto lg:mx-0 max-w-[440px] text-base lg:text-lg leading-relaxed text-slate-500">
        ...
        <div class="mt-10 lg:mt-14 space-y-6 lg:space-y-9">
          <div class="group flex flex-col lg:flex-row items-center lg:items-center gap-4 lg:gap-8">
      ...
      <div class="mt-4 lg:mt-16">
        <div class="contact-card-soft rounded-[22px] lg:rounded-[26px] bg-white/85 px-6 py-8 lg:px-9 shadow-[0_22px_55px_rgba(15,70,85,0.28)]">
          ...
          <form
            ...
            <div
              id="contactSuccess"
              class="overflow-hidden max-h-0 opacity-0 transition-all duration-300 ease-out text-sm text-green-700">
