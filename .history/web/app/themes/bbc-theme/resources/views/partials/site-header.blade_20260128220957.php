<header class="fixed inset-x-0 top-0 z-50 bg-slate-950/60 backdrop-blur-xs_OFF">
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden items-center gap-8 text-base text-slate-300 lg:flex">
        ...
        <a class="hover:text-white transition" href="#market-insights">Insights</a>

        <div class="ml-4 flex items-center gap-2 text-sm font-medium uppercase tracking-wide text-white">
