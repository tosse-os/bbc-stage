<section id="about" class="bg-[#F8F7F7] py-24 scroll-mt-24">
  <div class="container-content">
    ...
    <div class="grid grid-cols-1 items-start gap-16 lg:grid-cols-[40%_60%]">
      ...
      <div>
        ...
        <div class="mt-12 grid grid-cols-1 gap-x-16 gap-y-12 md:grid-cols-2">
          @for($i = 1; $i <= 4; $i++)
            ...
            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-lg font-medium text-brand-primary shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
