  ...
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden items-center gap-8 text-base text-slate-300 lg:flex">
        ...
        <div class="ml-4 flex rounded-md bg-white/5 p-0.5 text-xs font-medium uppercase tracking-wide text-white">
        ...
        {{ $lang['current_lang']
          ? 'bg-white/20 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.15)]'
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="ml-2 flex rounded-md bg-white/5 p-0.5 text-[11px] font-medium uppercase tracking-wide text-white lg:hidden">
          @php($langs = pll_the_languages(['raw' => 1]))
          @foreach($langs as $lang)
          <a
            href="{{ $lang['url'] }}"
