<section class="relative overflow-hidden bg-slate-950">
  <div class="absolute inset-0">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-slate-950/60 via-slate-950/40 to-transparent"></div>
  </div>
      ...
      <div>
        ...
        <div class="mt-10">
          <a
            ...
            class="inline-flex items-center rounded-xl bg-brand-primary px-6 py-3 text-base font-medium text-white hover:bg-brand-primaryHover transition">
            {{ $hero['cta_text'] }}
          </a>
        </div>
      </div>
