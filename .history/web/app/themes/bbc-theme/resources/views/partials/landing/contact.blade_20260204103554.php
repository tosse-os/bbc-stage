<section id="contact" class="relative overflow-hidden py-28 scroll-mt-20">
  ...
  <div class="relative container-content">
    <div
      class="grid gap-x-24 gap-y-16 items-start"
      style="grid-template-columns: 2fr 1.1fr; grid-template-rows: auto auto;">
      ...
      {{-- RIGHT: EMPTY SLOT (keeps top row clean) --}}
      <div></div>

      {{-- LEFT: BULLETS --}}
      <div class="mt-2 space-y-9">
      ...
      {{-- RIGHT: FORM (starts on text height) --}}
      <div>
