...
<section class="relative overflow-hidden bg-gradient-to-b from-[#dceff3] via-[#e7f4f7] to-[#eef7f9]">
  <div class="pointer-events-none absolute inset-0 opacity-[0.08]">
    <div class="h-full w-full bg-market-pattern"></div>
  </div>
    ...
    <div class="mt-16 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
      @for ($i = 1; $i <= 3; $i++)
        ...
        <div class="px-6 py-5 text-left">
          <h3 class="mt-4 text-[15.5px] leading-snug font-medium tracking-tight text-slate-800 transition-colors group-hover:text-slate-900">
            {{ $title }}
          </h3>
