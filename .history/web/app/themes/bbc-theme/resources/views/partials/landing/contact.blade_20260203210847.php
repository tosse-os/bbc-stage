<section id="contact" class="relative overflow-hidden py-28 scroll-mt-20">
  ...
  <div class="relative container-content">
    <div class="grid grid-cols-1 gap-20 lg:grid-cols-[2fr_1fr] items-start">
      ...
      <div>
        ...
        <div class="mt-16 space-y-10">
          <div class="flex items-center gap-5">
            ...
            <span class="text-lg font-medium text-[#0b3a4a]">Technical questions</span>
          </div>
          ...
          <div class="flex items-center gap-5">
            ...
            <span class="text-lg font-medium text-[#0b3a4a]">Enterprise / institutional access</span>
          </div>
          ...
          <div class="flex items-center gap-5">
            ...
            <span class="text-lg font-medium text-[#0b3a4a]">Data & API inquiries</span>
          </div>
        </div>
      </div>
        ...
        <div class="rounded-2xl bg-white/90 p-8 backdrop-blur shadow-[0_25px_70px_rgba(0,0,0,0.18)]">
          ...
          <form class="mt-6 space-y-4">
            <input
              ...
              class="w-full rounded-md border border-slate-300 px-4 py-2.5 text-sm focus:border-[#3f879c] focus:outline-none">

            <textarea
              rows="5"
              placeholder="How can we assist you?"
              class="w-full resize-none rounded-md border border-slate-300 px-4 py-2.5 text-sm focus:border-[#3f879c] focus:outline-none"></textarea>
