  ...
  <div class="relative container-content">
    <div class="grid grid-cols-1 lg:grid-cols-[1.6fr_1.1fr] gap-12 lg:gap-x-20 lg:gap-y-24 items-start">
      ...
      <div class="text-center lg:text-left">
        ...
        <p class="reveal-text mt-5 mx-auto lg:mx-0 max-w-[440px] text-base lg:text-lg leading-relaxed text-slate-500">
        ...
        <div class="mt-10 lg:mt-14 space-y-6 lg:space-y-9">
          <div class="reveal-text group flex flex-col lg:flex-row items-center lg:items-center gap-4 lg:gap-8">
            <div class=" element-float flex h-12 w-12 lg:h-13 lg:w-13 items-center justify-center rounded-xl bg-white/90 shadow-[0_10px_30px_rgba(15,70,85,0.16)] text-brand-primary transition-all duration-300 group-hover:scale-105 group-hover:bg-white group-hover:shadow-xl">
      ...
      {{-- RIGHT --}}
      <div class="mt-4 lg:mt-16 element-float">
        <div class="reveal-media contact-card-soft rounded-[22px] lg:rounded-[26px] bg-white/85 px-6 py-8 lg:px-9 shadow-[0_22px_55px_rgba(15,70,85,0.28)]">
