  ...
  <div class="container-content">
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          href="/login"
          class="flex h-9 w-9 items-center justify-center rounded-md bg-brand-primary text-white lg:hidden"
          aria-label="Login">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 14a4 4 0 10-8 0" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10a3 3 0 100-6 3 3 0 000 6z" />
          </svg>
        </a>

        <button
          id="mobileMenuToggle"
          class="flex h-9 w-9 items-center justify-center text-white lg:hidden"
...
<div
  id="mobileMenu"
  class="fixed inset-y-0 right-0 z-50 w-[270px] translate-x-full bg-slate-950/80 text-slate-200 transition-transform duration-300">

  <div class="flex h-16 items-center justify-between px-6">
    <span class="text-sm font-semibold uppercase tracking-wide">Menu</span>
    <button id="mobileMenuClose" class="h-7 w-7 text-white" aria-label="Close menu">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
