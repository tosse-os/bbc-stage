  ...
  <div class="relative container-content text-center">
    ...
    <div class="mt-16 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
      @for ($i = 1; $i <= 3; $i++)
        ...
        href="{{ $link }}"
        target="_blank"
        class="reveal-media group block overflow-hidden rounded-2xl bg-white shadow-[0_16px_40px_rgba(0,0,0,0.12)] transition-transform duration-300 hover:-translate-y-2 {{ $i === 2 ? 'market-insight--premium' : '' }}">
        ...
        <div class="relative aspect-video overflow-hidden">
          ...
          <span class="premium-banner">
            ...
            {{--
            <svg class="crown" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path d="M5 19H19V17H5V19ZM19 15L21 7L16 10L12 4L8 10L3 7L5 15H19Z"
                fill="currentColor" />
            </svg>
--}}
