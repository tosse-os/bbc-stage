...
<article class="max-w-6xl mx-auto space-y-8">
  ...
  <header class="bg-white/80 backdrop-blur rounded-xl px-6 py-4 flex items-start justify-between gap-6 shadow-sm">
    ...
    <div class="space-y-1">
      <h1 class="text-1xl md:text-2xl">{{ get_post_meta(get_the_ID(), 'report_asset_name', true) }}</h1>

      @if ($reportWkn || $reportIsin)
      <div class=" mt-1 text-sm text-slate-200 flex flex-wrap items-center gap-6 font-semibold">
