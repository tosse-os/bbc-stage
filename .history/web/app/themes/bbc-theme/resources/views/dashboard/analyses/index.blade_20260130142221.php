<section class="max-w-7xl">
  ...
  <div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="grid grid-cols-[160px_140px_1fr_140px_160px] px-6 py-4 border-b text-sm font-medium text-slate-500 items-center">
      <div>Market</div>
      <div>Preview</div>
    ...
    <div class="divide-y">
      ...
      <div class="relative grid grid-cols-[160px_140px_1fr_140px_160px] px-6 py-5 gap-4 items-start hover:bg-slate-50 transition">
        ...
        <div class="font-medium relative z-10">
        ...
        <div class="text-sm text-slate-500 whitespace-nowrap relative z-10">
          {{ date_i18n('d M, Y', strtotime(get_field('publish_date'))) }}
        </div>

        <div class="relative z-10">
          @if (can_view_analysis(get_current_user_id()))
          <span class="inline-flex items-center px-4 py-2 rounded-md bg-slate-100 hover:bg-slate-200 text-sm">
            View Report →
          </span>
          @else
