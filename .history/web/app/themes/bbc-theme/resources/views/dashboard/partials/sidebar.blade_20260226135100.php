...
<div class="md:hidden fixed bottom-0 left-0 right-0 z-40
  ...
  <div class="flex items-center justify-around min-h-[60px] py-2">

    <a href="/dashboard"
      class="flex flex-col items-center justify-center leading-none text-white text-xs">
      @include('dashboard.icons.overview')
    </a>
...
<div data-mobile-menu
  class="md:hidden fixed inset-0 z-50 hidden pointer-events-none">
  ...
  <div data-mobile-menu-panel
    ...
    {{-- SETTINGS --}}
    <a href="/dashboard-settings"
      class="flex items-center justify-between text-white py-2">
      <span>Account Settings</span>
    </a>

    <a href="/dashboard-about"
      class="flex items-center justify-between text-white py-2">
      <span>About Bloombridge</span>
    </a>
    ...
    <a href="/?dashboard_logout=1"
      class="flex items-center justify-center text-red-400 py-2">
      Logout
    </a>
