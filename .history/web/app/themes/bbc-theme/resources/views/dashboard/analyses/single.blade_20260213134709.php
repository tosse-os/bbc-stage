...
<article class="max-w-6xl mx-auto space-y-8">
  ...
  <header class="bg-white/80 backdrop-blur rounded-xl px-6 py-5 flex items-start justify-between gap-6 shadow-sm">

    <div class="space-y-3">

      {{-- ASSET TITLE --}}
      <h1 class="text-2xl md:text-3xl font-semibold tracking-tight text-heading">
      ...
      <div class="mt-1 text-sm text-muted flex flex-wrap items-center gap-6">
