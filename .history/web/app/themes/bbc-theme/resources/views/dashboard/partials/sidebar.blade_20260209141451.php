...
{{-- Logout Container --}}
<div class="py-2 border-t border-slate-800 text-sm">
  <a href="/?dashboard_logout=1"
    {{-- 'w-full' und 'justify-center' für den Min-Modus, 'lg:justify-start' und 'lg:px-4' für den Max-Modus --}}
    class="flex items-center justify-center lg:justify-start w-full lg:px-4 py-3 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/50 transition group">

    {{-- Icon-Container: Er ist der Anker für die Zentrierung --}}
    <div class="w-6 h-6 flex items-center justify-center flex-shrink-0">
      @include('dashboard.icons.logout')
    </div>

    {{-- Das Label: Wird nur im ausgeklappten Zustand durch 'ml-3' abgerückt --}}
    <span data-sidebar-label class="font-medium ml-3 hidden lg:block whitespace-nowrap">
      Logout
    </span>
  </a>
</div>
