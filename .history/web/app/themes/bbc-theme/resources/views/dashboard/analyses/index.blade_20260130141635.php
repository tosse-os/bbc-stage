<section class="max-w-7xl">
  ...
  <div class="bg-white rounded-xl shadow-sm">
    ...
    <div class="grid grid-cols-[200px_1fr_140px_160px] px-6 py-4 border-b text-sm font-medium text-slate-500 items-center">
      <div>Market</div>
    ...
    <div class="divide-y">
      ...
      <div class="grid grid-cols-[200px_1fr_140px_160px] px-6 py-5 gap-4 items-center">
        ...
        <div class="flex gap-4 items-start">
          ...
          <img
            ...
            class="w-32 aspect-video object-cover rounded-md shrink-0 mt-0.5">
          @endif
