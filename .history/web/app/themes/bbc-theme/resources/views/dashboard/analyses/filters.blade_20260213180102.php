  ...
  <form
    ...
    <div
      ...
      <div class="w-full md:w-[260px]">
        ...
        <div class="flex items-center rounded-lg border border-brand-primary/20 bg-white/50 px-3 py-1.5">

          {{-- Kalender Icon --}}
          <svg xmlns="http://www.w3.org/2000/svg"
            class="w-4 h-4 mr-2 text-slate-400 shrink-0"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="2">
          ...
          <input
            ...
            name="date_from"
            value="{{ $dateFrom }}"
            class="w-full bg-transparent text-sm outline-none appearance-none">

          {{-- Trennstrich --}}
          <span class="mx-2 text-slate-400 text-sm">–</span>
