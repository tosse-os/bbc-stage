...
<div class="dashboard-filter-bar sticky top-0 z-40 -mx-4 px-4 md:relative md:mx-0 md:px-0 md:z-10 mb-6" id="filter-main-container">
  <form
    ...
    id="analysis-filters"
    data-filter-panel
    class="bg-white/10 backdrop-blur-md_ border border-brand-primary/30 rounded-b-2xl md:rounded-2xl shadow-sm overflow-visible md:overflow-visible transition-all">
