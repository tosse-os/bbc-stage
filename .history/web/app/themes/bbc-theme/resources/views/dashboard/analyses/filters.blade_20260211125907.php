...
<div class="sticky top-0 z-40 -mx-4 px-4 md:relative md:mx-0 md:px-0 md:z-10 mb-6" id="filter-main-container">
  <form
    method="get"
    id="analysis-filters"
    data-filter-panel
    class="bg-white/90 backdrop-blur-xl border border-brand-primary/30 rounded-b-2xl md:rounded-2xl shadow-sm overflow-hidden md:overflow-visible transition-all">
    ...
    <div
      ...
      style="max-height:0; opacity:0; @media (min-width: 768px) { max-height: none; opacity: 1; }">
