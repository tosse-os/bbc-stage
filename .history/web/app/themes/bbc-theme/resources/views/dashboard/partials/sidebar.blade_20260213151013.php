...
<div class="mt-6 px-4">
  ...
  <div class="max-w-[80px] flex rounded-lg border border-[var(--border-color)] bg-[var(--surface-glass)] backdrop-blur-sm overflow-hidden text-xs font-semibold tracking-wide">
