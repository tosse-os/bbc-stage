...
<form
  ...
  {{-- Optimierter Header: Kompakter auf Mobile --}}
  <div class="flex items-center justify-between
              px-4 py-2.5 md:px-6 md:py-5 {{-- Weniger Padding oben/unten mobil --}}
              cursor-pointer md:cursor-default"
    data-filter-toggle> {{-- Ganze Zeile mobil klickbar machen --}}
    ...
    <div class="flex items-center gap-2">
      ...
      {{-- Optional: Hier ein kleiner Badge, wenn Filter aktiv sind --}}
      @if($currentAsset || $currentMarket || $dateFrom)
