<section class="max-w-7xl">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="relative group p-[1px] rounded-3xl transition-all duration-500 hover:scale-[1.01]">
      ...
      <div class="relative bg-slate-900/60 backdrop-blur-xl rounded-[23px] p-5 border border-white/5 shadow-2xl flex flex-col md:flex-row gap-6">

        {{-- Linke Seite: Cover Image --}}
        ...
        <div class="flex-1 flex flex-col justify-between">
          ...
          {{-- Dunkler Player-Balken passend zum Design --}}
          <div class="custom-audio-wrapper bg-slate-800/50 border border-white/5 rounded-2xl px-4 py-3 flex items-center gap-4 select-none">
            <audio src="{{ $audio['url'] }}" class="hidden-audio" preload="metadata"></audio>

            {{-- Play Button --}}
            <button class="play-btn w-10 h-10 flex-shrink-0 flex items-center justify-center bg-brand-primary rounded-full text-white hover:scale-105 active:scale-95 transition shadow-lg">
            ...
            <div class="flex-1 flex flex-col">
              ...
              {{-- Seek-Bar: Dunkler Hintergrund, Brand-Farbe für den Fortschritt --}}
              <input type="range"
                class="seek-bar w-full h-1.5 accent-brand-primary cursor-pointer appearance-none bg-slate-700 rounded-lg"
                value="0" step="0.1">
            </div>
