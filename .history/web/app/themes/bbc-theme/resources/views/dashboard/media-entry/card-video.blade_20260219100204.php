...
<div class="video-mini-player rounded-2xl overflow-hidden bg-slate-800/40 border border-white/5 flex items-center px-4 py-2 gap-4">
  {{-- Kompaktes Video-Icon oder Thumbnail-Trigger --}}
  ...
  <div class="flex-1">
    <span class="text-[10px] font-bold text-slate-300 uppercase tracking-tighter">Video-Beitrag ansehen</span>
  ...
  <a href="{{ $videoUrl }}" target="_blank" class="text-[10px] font-bold text-brand-primary hover:text-white transition uppercase">
    Abspielen
  </a>
</div>
@endif
