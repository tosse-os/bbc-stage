<section class="max-w-7xl">
  ...
  <div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    {{-- Tabellen Header: Jetzt mit deiner element-border-t (unten) für Konsistenz --}}
    <div class="element-border-b grid grid-cols-[160px_140px_1fr_140px_160px] px-6 py-4 gap-4 border-b border-slate-100 text-sm font-medium text-slate-500 bg-slate-50/50">
      <div>Asset</div>
      <div>Preview</div>
      <div>Description</div>
      <div>Date</div>
    ...
    <div class="flex flex-col">
      ...
      {{-- Jede Zeile bekommt nun 'element-border-t' statt dem harten 'divide-y' --}}
      {{-- 'hover:bg-slate-50/80' sorgt für den Interaktions-Effekt --}}
