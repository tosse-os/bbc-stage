...
<div class="md:hidden fixed bottom-0 left-0 right-0 z-40
            bg-brand-primary/90 backdrop-blur-xl">

  <div class="flex items-center justify-around min-h-[71px] py-2">
    ...
    <a href="/dashboard" class="flex flex-col items-center text-white text-xs">
      @include('dashboard.icons.overview')
    </a>

    <a href="/dashboard-reports" class="flex flex-col items-center text-white text-xs">
      @include('dashboard.icons.report')
    </a>

    <a href="/dashboard-media" class="flex flex-col items-center text-white text-xs">
      @include('dashboard.icons.media')
    </a>

    <button type="button"
      data-mobile-menu-toggle
      class="flex flex-col items-center text-white text-xs">
      @include('dashboard.icons.chevron-up')
    </button>
...
<div data-mobile-menu
  ...
  <div data-mobile-menu-panel
    class="absolute bottom-0 left-0 right-0
       bg-gradient-to-b from-slate-900/85 to-slate-900/75
    ...
    <button type="button"
      ...
      class="flex items-center justify-center w-full mb-4 text-white/70 hover:text-white transition">
    ...
    <button type="button"
      ...
      data-ajax="{{ admin_url('admin-ajax.php') }}"
      data-nonce="{{ wp_create_nonce('dashboard_theme_toggle') }}"
      class="w-full py-3 rounded-xl bg-slate-800 text-white">
      Theme wechseln
    </button>

    <a href="/dashboard-settings"
      class="block py-3 rounded-xl bg-slate-800 text-white text-center">
      Settings
    </a>

    <a href="/?dashboard_logout=1"
      class="block py-3 rounded-xl bg-red-500/80 text-white text-center">
      Logout
    </a>
