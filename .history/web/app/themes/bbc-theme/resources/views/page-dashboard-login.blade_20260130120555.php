  ...
  <section class="relative w-full max-w-[400px] mx-auto px-4">
    <div class="backdrop-blur-xl bg-white/[0.03] border border-white/10 rounded-2xl px-8 py-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] ring-1 ring-white/10 overflow-hidden relative">
      ...
      <div class="grid grid-cols-2 gap-3 mb-8">
        <button class="flex items-center justify-center gap-2 py-2.5 border border-white/10 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] transition text-[11px] font-bold uppercase tracking-wider">
      ...
      <form method="post" action="{{ esc_url(admin_url('admin-post.php')) }}" class="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-lg px-4 py-2.5 text-sm text-white placeholder-slate-500
    bg-gradient-to-b from-white/[0.08] to-white/[0.03]
    border border-white/20
    transition-all duration-300 ease-out
    hover:border-white/50
    hover:from-white/[0.14] hover:to-white/[0.05]
    hover:shadow-[0_0_18px_rgba(255,255,255,0.18)]
    focus:outline-none
    focus:border-brand-primary
    focus:from-brand-primary/[0.18] focus:to-white/[0.06]
    focus:shadow-[0_0_25px_rgba(64,136,158,0.45)]">
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              name="password"
              required
              class="password-input w-full rounded-lg bg-white/5 border border-white/20 px-4 py-2.5 pr-10 text-sm text-white
              transition-all duration-200
              hover:border-white/40 hover:shadow-[0_0_0_2px_rgba(255,255,255,0.08)]
              focus:outline-none focus:border-brand-primary
              focus:shadow-[0_0_0_3px_rgba(64,136,158,0.35)]
              focus:bg-white/10">
