...
/**
 * Initialisiert die clientseitige Validierung
 * für das Kontaktformular inkl. i18n und Fokus-Handling.
 */
function initContactFormValidation() {
  const form = document.getElementById('contactForm')
  if (!form || !window.ContactFormI18n) return

  const { lang, fallback, messages } = ContactFormI18n

  function t(key) {
    return messages[lang]?.[key] || messages[fallback][key]
  }
