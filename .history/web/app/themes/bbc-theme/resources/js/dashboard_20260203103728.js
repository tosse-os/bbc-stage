...
/**
 * Sidebar-Collapse-Logik für das Dashboard.
 * Schaltet die Sidebar zwischen breit und schmal um,
 * blendet Textlabels ein/aus, skaliert das Logo
 * und persistiert den Zustand im localStorage.
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /**
   * Wendet den Sidebar-Zustand (collapsed / expanded) an.
   */
  function apply(collapsed) {
    ...
    if (logo) {
      ...
      logo.classList.toggle('h-8', collapsed);
    }
