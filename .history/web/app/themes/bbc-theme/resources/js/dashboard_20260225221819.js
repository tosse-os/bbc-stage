...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /**
   * VIDEO MODAL SYSTEM
   * Öffnet Videos (YouTube + Vimeo) im Modal,
   * unterstützt ESC Close, Background Close,
   * Fade Animation und Autopause.
   */
  ...
  /**
   * Wandelt eine YouTube URL in Embed URL um
   */
  ...
  /**
   * Wandelt eine Vimeo URL in Embed URL um
   */
  ...
  /**
   * Pausiert aktuell laufende Videos (Autopause)
   */
  ...
  /**
   * Öffnet das Modal mit Fade Animation
   */
  ...
  /**
   * Schließt das Modal mit Fade Animation
   */
  function closeModal() {
  ...
  /**
   * Klick-Listener für Video-Trigger
   */
