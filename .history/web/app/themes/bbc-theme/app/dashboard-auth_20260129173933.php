...
/**
 * Dashboard-Registrierung (nicht öffentliches WP-Formular)
 *
 * Wird über admin-post.php?action=dashboard_register aufgerufen.
 * Erstellt einen neuen Benutzer, initialisiert automatisch den Trial
 * (über user_register Hook) und loggt den User direkt ein.
 * Anschließend Redirect ins Dashboard.
 */
...
/**
 * Erzwingt sauberen Redirect nach Logout aus dem Dashboard
 */
