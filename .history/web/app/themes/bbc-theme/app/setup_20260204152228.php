...
add_action('wp_enqueue_scripts', function () {
    wp_localize_script('vite-client', 'ContactFormI18n', [
        'lang' => function_exists('pll_current_language') ? pll_current_language() : 'en',
        'fallback' => 'en',
        'messages' => [
            'en' => [
                'email_required' => get_option('contact_validation_email_required_en', 'Please enter your e-mail address.'),
                'email_invalid' => get_option('contact_validation_email_invalid_en', 'Please enter a valid e-mail address.'),
                'message_required' => get_option('contact_validation_message_required_en', 'Please enter a message.'),
            ],
            'de' => [
                'email_required' => get_option('contact_validation_email_required_de'),
                'email_invalid' => get_option('contact_validation_email_invalid_de'),
                'message_required' => get_option('contact_validation_message_required_de'),
            ],
        ],
    ]);
});
