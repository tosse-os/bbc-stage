...
add_action('wp_head', function () {
    $fonts = [
        'open-sans-v43-latin-300.woff2',
        'open-sans-v43-latin-400.woff2',
        'open-sans-v43-latin-500.woff2',
        'open-sans-v43-latin-600.woff2',
        'open-sans-v43-latin-700.woff2',
        'open-sans-v43-latin-800.woff2',
    ];

    foreach ($fonts as $font) {
        echo '<link rel="preload" href="' .
            \Illuminate\Support\Facades\Vite::asset('resources/fonts/' . $font) .
